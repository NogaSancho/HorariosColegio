    ...
    <>
        <div className="col-sm-14">
          <div className="input-group mb-3" id={`materias-${currentLetraFiltro}s`}>
            <label className="input-group-text" htmlFor="inputGroupSelect01" style={currentColorSemester == "azul" ? {backgroundColor: 'blue'} : {backgroundColor: 'green'}}>{currentLetraFiltro}</label>
